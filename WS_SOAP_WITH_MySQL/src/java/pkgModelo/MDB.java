...
public class MDB {
    ...
    public MDB() {
        String BD_DIRECT = "jdbc:mysql://db4free.net:3306/bdtiendasoa?user=bdtiendasoa&password=jCLBdmtXlT&characterEncoding=utf8";
        //useUnicode=true&useJDBCCompliantTimezoneShift=true&useLegacyDatetimeCode=false&useTimezone=true&serverTimezone=GMT&useSSL=false";
        ...
        conexion = new Conexion("com.mysql.jdbc.Driver", "jdbc:mysql://db4free.net:3306/bdtiendasoa?characterEncoding=utf8&useSSL=false&useUnicode=true", "bdtiendasoa", "jCLBdmtXlT");//ESTA CADENA LARGA SE USA PARA MAC Y PARA ALGUNAS INSTALACIONES RECIENTES DE MYSQL
